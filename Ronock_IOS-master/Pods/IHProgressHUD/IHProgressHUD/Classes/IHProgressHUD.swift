...
//                self.frame = containerView!.frame
    ...
    private func updateHUDFrame() {
        ...
        if getStatusLabel().text != nil {
            ...
            labelRect = getStatusLabel().text?.boundingRect(with: constraintSize, options: [.usesFontLeading, .truncatesLastVisibleLine, .usesLineFragmentOrigin], attributes: [NSAttributedString.Key.font: getStatusLabel().font ?? 0], context: nil) ?? CGRect.zero
