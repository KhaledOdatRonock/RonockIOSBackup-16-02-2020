...
//        NotificationCenter.default.addObserver(self, selector: #selector(SelectionDialog.deviceOrientationDidChange(_:)), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)
    }
